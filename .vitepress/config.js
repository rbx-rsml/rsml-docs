...
export default defineConfig({
  ...
  markdown: {
    languages: [
      JSON.parse(
        fs.readFileSync("./.vitepress/syntaxes/rsml.tmLanguage.json", "utf8"),
      ),

      JSON.parse(
        fs.readFileSync(
          "./.vitepress/syntaxes/rsml-types.tmLanguage.json",
          "utf8",
        ),
      ),

      JSON.parse(
        fs.readFileSync("./.vitepress/syntaxes/luau.tmLanguage.json", "utf8"),
      ),

      {
        ...
        ...JSON.parse(
          fs.readFileSync(
            "./.vitepress/syntaxes/rsml-luau.tmLanguage.json",
            "utf8",
          ),
        ),
      },
      ...
      JSON.parse(
        fs.readFileSync("./.vitepress/syntaxes/ts.tmLanguage.json", "utf8"),
      ),

      {
        ...
        ...JSON.parse(
          fs.readFileSync(
            "./.vitepress/syntaxes/rsml-ts.tmLanguage.json",
            "utf8",
          ),
        ),
      },
